 ...
 * @brief Opengl is a dynamic library, because it is differ for each GPU driver
...
//#define GL_POLYGON_MODE                   0x0B40 //legacy
...
#define GL_UNPACK_ROW_LENGTH              0x0CF2//legacy
...
typedef void (APIENTRYP PFNGLPOLYGONMODEPROC) (GLenum face, GLenum mode);//legacy
typedef void (APIENTRYP PFNGLSCISSORPROC) (GLint x, GLint y, GLsizei width, GLsizei height);//legacy
...
typedef void (APIENTRYP PFNGLPIXELSTOREFPROC) (GLenum pname, GLfloat param);//GL only
typedef void (APIENTRYP PFNGLPIXELSTOREIPROC) (GLenum pname, GLint param);//GLES3
...
GLAPI PFNGLUNIFORMMATRIX2X3FVPROC glUniformMatrix3x2fv;
GLAPI PFNGLUNIFORMMATRIX2X3FVPROC glUniformMatrix2x4fv;
GLAPI PFNGLUNIFORMMATRIX2X3FVPROC glUniformMatrix4x2fv;
GLAPI PFNGLUNIFORMMATRIX2X3FVPROC glUniformMatrix3x4fv;
GLAPI PFNGLUNIFORMMATRIX2X3FVPROC glUniformMatrix4x3fv;
/* ----------------------------- GL_VERSION_3_0 ---------------------------- \*/
